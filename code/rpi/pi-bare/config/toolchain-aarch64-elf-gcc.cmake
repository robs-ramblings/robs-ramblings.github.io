#
# Toolchain file for 32bit kernel code on Rpi0-4 (Rpi5 doesn't allow 32bit kernel code)
...
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
  ...
  set(CMAKE_C_FLAGS "-ffreestanding  -fno-exceptions -Wall -Wextra -fno-exceptions -fno-unwind-tables -g -O0 -DDEBUG -DCONFIG_AARCH64 -march=${CMAKE_SYSTEM_PROCESSOR}")
elseif(CMAKE_BUILD_TYPE STREQUAL "Release")
  #message("-- Build configuration is Release compiling for size")
  set(CMAKE_C_FLAGS "-ffreestanding  -fno-exceptions -Wall -Wextra -fno-exceptions -fno-unwind-tables -g -Os -DCONFIG_AARCH64 -march=${CMAKE_SYSTEM_PROCESSOR}")
else()
...
# set flags for the linker (move above if they need to be based on debug/release)
# do not add the linker script here, it is added in the CMakeLists.txt
set(CMAKE_EXE_LINKER_FLAGS "-nostdlib -lgcc -Wl,--defsym=LOADER_ADDRESS=0x80000")
